    ...
    <section id="education" className="bg-white dark:bg-gray-800 py-4">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
          Learning is the foundation of growth. Here's a glimpse into my
          educational background—the knowledge and skills that have fueled my
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-8">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Web programming and object-based programming practicum
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Teaching Augmented Reality with Spark AR for SMA and SMK
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h5 className="font-medium text-gray-900 dark:text-white">
                  Web Design Competition Finalist
                </h5>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  State University of Malang (2021)
                </p>
              </div>
            </div>
          </div>
